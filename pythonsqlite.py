...
def main():
    ...
    sql_original_tweets_table = """CREATE TABLE IF NOT EXISTS originalTweets (
                                        ...
                                        organic_metrics_like_count integer,
                                        promoted_metrics text,
                                        ...
                                        promoted_metrics_like_count integer,
...
#                                             FOREIGN KEY (user_id_str) REFERENCES processedTweets (author_id)
